...
# one-level decision tree (sometimes called decision stump)
...
# maximal tree
# here, we are going to use {rpart}'s default value of `maxdepth`, which is 30
...
# the first pruning:
# node number 7 is corresponding to t5 in the book
T2 <- snip.rpart(T1, toss = 7) 
print(T2)
...
# ex8.7
# compute misclassification rate on test data for T1, T2, and T3 
